...
The 11 September refinement browser evidence and remaining live-setup requirement are recorded in [refinement QA](design/2026-09-refinement/QA.md). The OAuth client form is prepared in the existing Rushes project; credential creation and real Google consent are pending user confirmation.
